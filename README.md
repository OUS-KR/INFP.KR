...
- `INFP.KR/u/{사용자 아이디}` 주소 기반의 사용자 등록
  - 사용자 예제: [INFP.KR/u/infp](https://infp.kr/u/infp) ([INFP.KR/@infp](https://infp.kr/@infp))
...
- `INFP.KR/u/{사용자 아이디}/{단축 경로}` 형태의 단축주소 생성
  - 사용자 단축주소 예제: [INFP.KR/u/infp/links/infp-kr](https://infp.kr/u/infp/links/infp-kr) ([INFP.KR/@infp/links/infp-kr](https://infp.kr/@infp/links/infp-kr))
...
- `INFP.KR/u/{사용자 아이디}/{글 경로}` 형태의 글 작성
  - 사용자 글 예제: [INFP.KR/u/infp/articles/example](https://infp.kr/u/infp/articles/example) ([INFP.KR/@infp/articles/example](https://infp.kr/@infp/articles/example))
