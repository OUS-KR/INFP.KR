...
- `INFP.KR/u/{사용자 아이디}/{단축 경로}` 형태의 단축주소 생성
  ...
  - 동일한 단축 경로 존재 시 덮어쓰기
- `INFP.KR/@{사용자 아이디}/{단축 경로}` 형태의 짧은 주소 지원
  - 사용자 단축주소 예제: [INFP.KR/@infp/links/infp-kr](https://infp.kr/@infp/links/infp-kr)
- 단축 경로가 `links`로 시작하면 `INFP.KR/@{사용자 아이디}/!{links를 제외한 단축 경로}` 형태로 생략 가능
  - 사용자 단축주소 예제: [INFP.KR/@infp/!infp-kr](https://infp.kr/@infp/!infp-kr)
...
- `INFP.KR/u/{사용자 아이디}/{글 경로}` 형태의 글 작성
  ...
  - 동일한 글 경로 존재 시 덮어쓰기
  - 글 경로 미입력 시 `INFP.KR/u/{사용자 아이디}/` 페이지 수정
- `INFP.KR/@{사용자 아이디}/{글 경로}` 형태의 짧은 주소 지원
  - 사용자 글 예제: [INFP.KR/@infp/articles/example](https://infp.kr/@infp/articles/example)
...
- [Issues 메뉴](https://github.com/OUS-KR/INFP.KR/issues) 이동
...
- 매일 자정 0시부터 매 2시간마다 반영 작업 시작 (0시, 2시, 4시, ..., 18시, 20시, 22시)
  ...
  - 미리보기 도메인: `PREVIEW-NRP.INFP.KR` (예: [PREVIEW-NRP.INFP.KR/public/u/infp/](https://preview-nrp.infp.kr/public/u/infp/))
- 다음과 같은 콘텐츠 포함 시 제재
...
![카운터](https://s11.flagcounter.com/count2/AIcE/bg_FFFFFF/txt_000000/border_CCCCCC/columns_2/maxflags_10/viewers_0/labels_1/pageviews_1/flags_0/percent_0/)